...
namespace GOAP_Refactored
{
    ...
    public class WorldState : IEquatable<WorldState>, IComparable
    {
        ...
        public void Add(string key, object value, Func<object> bindingMethod) { States.TryAdd(key, new State(value, bindingMethod)); }

        public void Add(string key, State state) { States.TryAdd(key, state); }
        ...
        public void CopyStateValue(string key, State other)
        {
        ...
        public bool IsContained(WorldState other)
        {
            ...
            {
                if (!other.States.TryGetValue(key, out State otherState)) return false;
    ...
    /// <summary>
    /// Class that represents a single state within the WorldState
    ...
    public class State : IEquatable<State>
    {
        ...
        public State(object value, Func<object> method)
        {
            Value = value;
            ValueFunc = method;
        }
